...
def check_login():
    if st.session_state.get("authenticated"):
        return True
    st.markdown("""
    <div style="max-width:380px;margin:80px auto 0;text-align:center;font-family:sans-serif;">
      <div style="font-size:3rem;">🏆</div>
      <h2 style="margin:8px 0 4px;">Mi Álbum Mundial 2026</h2>
      <p style="color:#666;font-size:0.9rem;margin-bottom:24px;">Iniciá sesión para acceder</p>
    </div>
    ...
    if ok:
        valid_user = st.secrets.get("APP_USER", "julianszruiz")
